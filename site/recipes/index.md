...
New to SMDT? Start with [Getting Started](./getting-started.md). It verifies your installation, configures your database connection, and runs your first standardizer. Every other recipe assumes you have done this.
...
Add computed features to posts you have already ingested: sentiment, toxicity, language, embeddings, or any custom signal.
...
- **[Cross-Platform Analysis (MultiStore)](./analysis/multistore.md)**: attach multiple per-dataset databases into one DuckDB connection and join or union across them with plain SQL.
