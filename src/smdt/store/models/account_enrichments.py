...
class AccountEnrichments:
    ...
    # Optional class metadata (good with your StandardDB registry)
    __table_name__ = "account_enrichments"
    ...
    def __post_init__(self):
        ...
        # account_id required and trimmed
    ...
    @classmethod
    def from_db_row(cls, row: Mapping[str, Any]) -> "AccountEnrichments":
        """
        Hydrate an AccountEnrichments instance from a dict-like DB row.
        """
        return cls(
    ...
    def make_bulk_params(
        items: List["AccountEnrichments"], include_id: bool = False
    ) -> List[Tuple[Any, ...]]:
        """
        Convert a list of AccountEnrichments into INSERT parameter tuples.
        """
